...
final class HardDeleteNotesFromLocalUseCase implements UseCase<DataState<bool>, List<int>> {
  @override
  Future<DataState<bool>> execute({List<int>? params}) {
    return serviceLocator<NotesRepository>().hardDeleteNotesFromLocal(params!);
  }
}